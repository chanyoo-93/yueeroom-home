  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-12">
      ...
      <p className="mb-6 text-sm text-gray-600">
        유이룸(이하 &quot;회사&quot;)은 한국 개인정보보호법(PIPA)을 준수하며, 이용자의 개인정보를
        안전하게 보호합니다. 본 방침은 2026년 4월 24일부터 시행됩니다.
      </p>

      <section className="mb-8">
        <h2 className="mb-3 text-lg font-semibold">1. 수집하는 개인정보 항목 및 수집 방법</h2>
        <p className="mb-2 text-sm">회사는 서비스 제공을 위해 다음 항목을 수집합니다.</p>
        <ul className="list-disc pl-6 text-sm text-gray-700">
          <li>필수: 이메일 주소, 이름, 비밀번호</li>
          <li>선택: 전화번호, 배송지 정보, 자녀 정보(이름, 생년월일, 성별, 신체 정보)</li>
          <li>자동 수집: 서비스 이용 기록, 접속 IP, 쿠키</li>
        </ul>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc pl-6 text-sm text-gray-700">
          <li>전자 파일: 복구 불가능한 방법으로 영구 삭제 (개인식별정보 익명화 처리)</li>
      ...
      <section className="mb-8">
        ...
        <ul className="list-disc pl-6 text-sm text-gray-700">
          <li>개인정보 열람 요청: 마이페이지 → 내 프로필에서 직접 확인</li>
          <li>개인정보 정정 요청: 마이페이지 → 프로필 수정</li>
          <li>개인정보 삭제 요청 (회원 탈퇴): 마이페이지 → 회원 탈퇴</li>
          <li>처리 정지 요청: 고객센터(privacy@yueeroom.com)로 이메일 문의</li>
        </ul>
        <p className="mt-2 text-sm text-gray-700">
      ...
      <section className="mb-8">
        ...
        <ul className="list-none text-sm text-gray-700">
          <li>책임자: 개인정보 보호책임자</li>
          <li>이메일: privacy@yueeroom.com</li>
          <li>침해 신고: 개인정보침해 신고센터 (privacy.kisa.or.kr / 국번없이 118)</li>
        </ul>
        <p className="mt-2 text-sm text-gray-700">
