...
const policySections = [
  ...
  {
    title: '4. 만 14세 미만 아동의 개인정보 처리에 관한 사항',
    paragraphs: [
  ...
  {
    title: '6. 개인정보처리의 위탁에 관한 사항',
    paragraphs: [
      '(1) 회사는 원활한 개인정보 업무처리를 위하여 다음과 같이 개인정보 처리업무를 위탁하고 있습니다.',
      '수탁업체 / 위탁업무',
      '카페24(주) / 쇼핑몰 호스팅 서비스의 시스템 제공 및 유지∙보수',
      'CJ대한통운, 우체국 택배 등 및 각 판매처 별 지정 택배사 / 상품 배송 업무 및 배송 위치 추적 서비스 제공',
      '이지페이 / [PG사 위탁 내용]',
  ...
  {
    title: '8. 정보주체와 법정대리인의 권리·의무 및 그 행사방법에 관한 사항',
    paragraphs: [
  ...
  {
    title: '10. 개인정보를 자동으로 수집하는 장치의 설치·운영 및 그 거부에 관한 사항',
    paragraphs: [
  ...
  },
  {
    ...
    paragraphs: ['이 개인정보처리방침은 2026년 4월 16일부터 적용됩니다.'],
  },
];
  ...
  return (
    <main className="mx-auto max-w-3xl px-4 py-12">
      ...
      <p className="mb-4 text-sm text-gray-700">
        {`유이 룸(Yu-ee Room)은 (이하 "회사"는) 「개인정보 보호법」 제30조에 따라 이용자의 개인정보를 보호하고 이와 관련한 고충을 신속하고 원활하게 처리할 수 있도록 하기 위하여 다음과 같이 개인정보처리방침을 수립·공개합니다.`}
      </p>
        ...
        <section key={section.title} className="mb-8">
          ...
          <div className="space-y-2">
            {section.paragraphs.map((paragraph, index) => (
              <p key={`${section.title}-${index}`} className="text-sm leading-6 text-gray-700">
                {paragraph}
              </p>
            ))}
          </div>
      ...
      <p className="mt-8 text-xs text-gray-500">시행일: 2026년 4월 16일</p>
    </main>
  );
}
